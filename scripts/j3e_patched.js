const J3e = ({ isOpen: e, onClose: t, onSave: r, instrumentToEdit: n, defaultCategory: defCat = "NORMAL STANDARD", totalInstrumentsCount: l, currentTab, activeTab: activeTabProp }) => {
      ...
      h("div", {
        ...
        activeTab === "history" && h("div", { className: "space-y-4" },
          ...
          h("div", { className: "space-y-3" },
            ...
            (Array.isArray(historyList) ? historyList : []).map((item, idx) => {
